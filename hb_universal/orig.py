...
class hb_universal(rtl,eldo,thesdk):
    @property
    def _classfile(self):
    ...
    def run(self,*arg):
        ...
        if self.model=='py':
          ...
          if self.model=='vhdl':
              ...
              # Example of defining supplies (not used here because the example hb_universal has no supplies)
...
if __name__=="__main__":
    ...
    controller=hb_universal_controller()
    controller.Rs=rs
    #controller.reset()
